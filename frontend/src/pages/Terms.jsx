...
const Section = ({ title, children }) => (
  <div className="mb-10">
    <h2 className="font-display font-bold text-xl sm:text-2xl text-white mb-4 pb-2 border-b border-blue-500/20">{title}</h2>
    ...
    <div className="min-h-[100dvh] page-bg-blue pt-20 sm:pt-24 pb-16 sm:pb-20 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-start gap-4 mb-10">
          ...
          <div>
            <h1 className="font-display font-bold text-3xl sm:text-4xl text-white mb-2"><span className="shimmer-blue">Terms</span> of Service</h1>
        ...
        <div className="glass rounded-3xl p-6 sm:p-10 border border-blue-500/15">
          ...
          <Section title="10. Contact">
            <p>For questions about these Terms, contact us at <a href="mailto:harshvardhan1412002@gmail.com" className="text-indigo-400 hover:underline">harshvardhan1412002@gmail.com</a>.</p>
          </Section>
        </div>
      </div>
    </div>
