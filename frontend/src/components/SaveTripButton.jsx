    ...
    return (
      <div className={`flex flex-wrap items-center gap-2 ${className}`}>
        ...
        <button
          type="button"
          onClick={handleCopy}
          className="inline-flex items-center gap-1.5 text-xs sm:text-sm px-3 py-2 rounded-xl glass border border-white/10 hover:border-white/20 text-slate-200 hover:text-white transition-colors"
          aria-live="polite"
        >
          {copied ? (
            <>
        ...
        <Link
          to="/saved"
          className="inline-flex items-center gap-1.5 text-xs sm:text-sm px-3 py-2 rounded-xl glass border border-white/10 hover:border-white/20 text-slate-300 hover:text-white transition-colors"
        >
  ...
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      <button
        ...
        onClick={handleSave}
        disabled={saving}
        className="inline-flex items-center justify-center gap-2 text-sm text-slate-100 px-3.5 sm:px-4 py-2.5 rounded-xl glass border border-emerald-500/30 hover:border-emerald-400/60 hover:bg-emerald-500/10 disabled:opacity-60 transition-colors"
      >
